...
with tab2:
    st.header("อื่นๆ")
    user2 = st.selectbox("เลือกเนื้อหา", ["เครื่องคิดเลข", "เกี่ยวกับ", "แสดงความคิดเห็น"])
    st.divider()
    ...
    if user2 == "เกี่ยวกับ":
        ...
        st.write("เว็บไซต์นี้เป็นเว็บไซต์แรกของผม")
        st.write("Made with love ❤️")
        st.caption("สร้างโดย wasin")
    if user2 == "แสดงความคิดเห็น":
        st.header("ความคิดเห็น")
        st.markdown("""
    [แสดงความคิดเห็นที่นี่](https://docs.google.com/forms/d/1xNvb5eHftWDDJ5TR48sKYBVRywIh7Q5R87L9laKdZVE/edit)  
""")
